...
:: ============================================================================
::  Magnet Log Collector - Cai dat TOAN BO chi bang 1 file .bat nay
...
::  de chay dung tren moi bang ma he thong (locale) cua Windows.
:: ============================================================================
...
echo.
echo ==============================================================
echo   MAGNET LOG COLLECTOR - CAI DAT TOAN BO
echo ==============================================================
echo.
echo   [NHAC] Truoc khi tiep tuc, hay chac chan da mo file config.json
echo   va kiem tra "sourceDir" (duong dan thu muc chua file Excel tren
echo   CHINH MAY NAY) va thong tin "db" cho dung.
echo.
pause
echo.
...
echo [2/3] Dang cai dependencies (mssql, xlsx...)...
call npm install
if errorlevel 1 (
...
echo ==============================================================
echo   HOAN TAT!
echo   Service "MagnetLogCollector" dang chay ngam, tu khoi dong lai
echo   cung Windows tu lan sau tro di.
echo   Xem log tai: %~dp0logs\
echo ==============================================================
echo.
pause
exit /b 0
